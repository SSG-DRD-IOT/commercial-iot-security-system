...
def regionSelect(event, x, y, flags, param):
    # print(selecting)
    global xi, yi, xf, yf, selecting, draw
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        # draw = True
        # if draw == True:
            # cv2.rectangle(frame, (xi, yi), (x, y), (255, 0, 0), 5)
...
while(1):
    ...
    if selecting == False:
        cv2.rectangle(frame, (xi, yi), (xf, yf), (255, 0, 0), 5)
    else:
        # print(xi, yi)
        # print()
        # print(xc, yc)
        # print('---')
        cv2.rectangle(frame, (xi, yi), (xc, yc), (0, 255, 0), 5)
    # print(xi, yi)
    print(draw)
